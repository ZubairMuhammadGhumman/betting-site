  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute top-8 left-8 text-yellow-300 text-[180px] animate-spin-slow opacity-90">
          ♠
        </div>
        <div className="absolute top-16 right-16 text-red-300 text-[160px] animate-bounce opacity-90">
          ♥
        </div>
        <div className="absolute bottom-16 left-16 text-yellow-300 text-[140px] animate-pulse opacity-90">
          ♦
        </div>
        <div className="absolute bottom-8 right-8 text-green-300 text-[170px] animate-spin-slow opacity-90">
          ♣
        </div>
        {/* Slot və Dice - NƏHƏNG ÖLÇÜLƏR */}
        <div className="absolute top-1/3 right-1/3 text-[200px] animate-pulse opacity-80">
          🎰
        </div>
        <div className="absolute bottom-1/3 left-1/3 text-[180px] animate-bounce opacity-80">
          🎲
        </div>
        {/* Əlavə dekorativ elementlər - BÖYÜK ÖLÇÜLƏR VƏ PARLAQ */}
        <div className="absolute top-1/4 right-1/4 text-green-300 text-[120px] animate-pulse delay-300 opacity-85">
          💎
        </div>
        <div className="absolute bottom-1/4 left-1/4 text-yellow-300 text-[130px] animate-spin-slow delay-700 opacity-85">
          👑
        </div>
        <div className="absolute top-3/4 right-1/2 text-red-300 text-[90px] animate-bounce delay-1500 opacity-75">
          🃏
        </div>
        <div className="absolute top-1/2 left-1/4 text-purple-300 text-[100px] animate-pulse delay-2000 opacity-75">
          💰
        </div>
        <div className="absolute top-1/6 left-1/2 text-blue-300 text-[80px] animate-spin-slow delay-2500 opacity-75">
          🎯
        </div>
        <div className="absolute bottom-1/6 right-1/6 text-orange-300 text-[110px] animate-pulse delay-3000 opacity-85">
          🏆
        </div>
        {/* Yeni əlavə ornamentlər - BÖYÜK VƏ PARLAQ */}
        <div className="absolute top-2/3 left-1/6 text-pink-300 text-[70px] animate-bounce delay-1000 opacity-70">
          🌟
        </div>
        <div className="absolute top-1/5 right-1/5 text-cyan-300 text-[80px] animate-pulse delay-1800 opacity-70">
          💫
        </div>
        <div className="absolute bottom-2/3 right-2/3 text-lime-300 text-[70px] animate-spin-slow delay-2200 opacity-70">
          ⭐
        </div>
        {/* Əlavə casino elementləri - BÖYÜK */}
        <div className="absolute top-1/8 left-1/8 text-yellow-200 text-[60px] animate-pulse delay-4000 opacity-60">
          🎪
        </div>
        <div className="absolute bottom-1/8 right-1/8 text-red-200 text-[65px] animate-bounce delay-4500 opacity-60">
          🎊
        </div>
        <div className="absolute top-5/6 left-5/6 text-purple-200 text-[55px] animate-spin-slow delay-5000 opacity-60">
          🎭
        </div>
        ...
        <div className="absolute top-1/12 left-1/3 text-yellow-200 text-[40px] animate-pulse delay-5500 opacity-50">
          🎲
        </div>
        <div className="absolute top-11/12 right-1/3 text-red-200 text-[45px] animate-bounce delay-6000 opacity-50">
          🎰
        </div>
        <div className="absolute top-1/2 left-1/12 text-green-200 text-[35px] animate-spin-slow delay-6500 opacity-50">
          ♠
        </div>
        <div className="absolute top-1/2 right-1/12 text-blue-200 text-[40px] animate-pulse delay-7000 opacity-50">
          ♥
        </div>
